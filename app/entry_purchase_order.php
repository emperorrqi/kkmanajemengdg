...
.alert-success{background:#dcfce7;padding:12px;border-radius:10px;margin-bottom:15px}
.alert-error{background:#fee2e2;padding:12px;border-radius:10px;margin-bottom:15px}
...
<tr>
    <td><span class="badge"><?= htmlspecialchars($r['kode_po']) ?></span></td>
