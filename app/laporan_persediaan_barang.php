...
.back-btn:hover{background:#020617}
...
@media print{
    ...
    .btn,.summary,.filter,.back-btn{display:none}
}
</style>
</head>
...
<h1>
📦 <?= $isPrint ? 'LAPORAN PERSEDIAAN BARANG' : 'LAPORAN PERSEDIAAN BARANG' ?>
</h1>
...
<tr>
    ...
    <td class="<?= $r['stok_akhir'] <= 0 ? 'stok-habis' : 'stok-aman' ?>">
        <?= $r['stok_akhir'] ?>
    </td>
